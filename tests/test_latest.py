...
def test_latest_only_keeps_newest_per_name():
    ...
    kept, superseded = latest_only([old, new, other])
...
def test_versionless_sources_form_single_groups():
    ...
    kept, superseded = latest_only([nd1, nd2, lst])
