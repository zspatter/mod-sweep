...
Master copy for the NexusMods description. Nexus uses BBCode in its editor;
the structure below translates directly (headings → [size], bullets →
[list]). Keep this file authoritative and re-paste on changes.
